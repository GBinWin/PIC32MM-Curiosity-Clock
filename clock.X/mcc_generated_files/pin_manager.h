...
/***user keys **/
#define KEY1_GetValue()      PORTAbits.RA9
#define KEY2_GetValue()      PORTCbits.RC8
#define KEY3_GetValue()      PORTCbits.RC2
#define KEY4_GetValue()      PORTCbits.RC3

#define LED2_SetHigh()          ( LATCSET = (1 << 9) )
/**
...
*/
#define CS_SetHigh()          ( LATBSET = (1 << 11) )
/**
  @Summary
...
*/
#define CS_GetValue()         PORTBbits.RB11
/**
  @Summary
...
*/
#define CS_SetDigitalInput()   ( TRISBSET = (1 << 11) )
/**
  @Summary
...
*/
#define CS_SetDigitalOutput()   ( TRISBCLR = (1 << 11) )
/**
  @Summary
...
*/
#define DC_SetHigh()          ( LATBSET = (1 << 12) )
/**
  @Summary
...
*/
inline static void DC_SetValue(bool value)
{
  if(value)
  {
    DC_SetHigh();
...
*/
#define DC_GetValue()         PORTBbits.RB12
/**
  @Summary
...
*/
#define DC_SetDigitalInput()   ( TRISBSET = (1 << 12) )
/**
  @Summary
...
*/
#define DC_SetDigitalOutput()   ( TRISBCLR = (1 << 12) )
/**
  @Summary
...
*/
#define RES_SetHigh()          ( LATBSET = (1 << 13) )
/**
  @Summary
...
*/
#define RES_SetLow()           ( LATBCLR = (1 << 13) )
...
*/
inline static void RES_SetValue(bool value)
{
  if(value)
  {
    RES_SetHigh();
...
*/
#define RES_Toggle()           ( LATBINV = (1 << 13) )
/**
  @Summary
  ...
  @Example
    ...
    // Read RB13
    postValue = RES_GetValue();
    </code>

*/
#define RES_GetValue()         PORTBbits.RB13
/**
  @Summary
...
*/
#define RES_SetDigitalInput()   ( TRISBSET = (1 << 13) )
/**
  @Summary
  ...
  @Example
    ...
    RES_SetDigitalOutput();
    </code>

*/
#define RES_SetDigitalOutput()   ( TRISBCLR = (1 << 13) )
/**
  @Summary
...
*/
#define D1_SetHigh()          ( LATBSET = (1 << 14) )
/**
  @Summary
...
*/
inline static void D1_SetValue(bool value)
{
  if(value)
  {
    D1_SetHigh();
...
*/
#define D1_GetValue()         PORTBbits.RB14
/**
  @Summary
...
*/
#define D1_SetDigitalInput()   ( TRISBSET = (1 << 14) )
/**
  @Summary
...
*/
#define D1_SetDigitalOutput()   ( TRISBCLR = (1 << 14) )
/**
  @Summary
...
*/
#define D0_SetHigh()          ( LATBSET = (1 << 15) )
/**
  @Summary
...
*/
inline static void D0_SetValue(bool value)
{
  if(value)
  {
    D0_SetHigh();
...
*/
#define D0_GetValue()         PORTBbits.RB15
/**
  @Summary
...
*/
#define D0_SetDigitalInput()   ( TRISBSET = (1 << 15) )
/**
  @Summary
...
*/
#define D0_SetDigitalOutput()   ( TRISBCLR = (1 << 15) )
